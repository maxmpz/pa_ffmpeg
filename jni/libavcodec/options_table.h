...
#endif
{"threads", N("set the number of threads"), OFFSET(thread_count), AV_OPT_TYPE_INT, {.i64 = 1 }, 0, INT_MAX, V|A|E|D, "threads"},
#if !PAMP_CHANGES
...
{"color_primaries", N("color primaries"), OFFSET(color_primaries), AV_OPT_TYPE_INT, {.i64 = AVCOL_PRI_UNSPECIFIED }, 1, INT_MAX, V|E|D, "color_primaries_type"},
#if !PAMP_CHANGES
...
#endif
{"colorspace", N("color space"), OFFSET(colorspace), AV_OPT_TYPE_INT, {.i64 = AVCOL_SPC_UNSPECIFIED }, 0, INT_MAX, V|E|D, "colorspace_type"},
#if !PAMP_CHANGES
...
#endif
{"color_range", N("color range"), OFFSET(color_range), AV_OPT_TYPE_INT, {.i64 = AVCOL_RANGE_UNSPECIFIED }, 0, INT_MAX, V|E|D, "color_range_type"},
#if !PAMP_CHANGES
...
#endif
{"chroma_sample_location", N("chroma sample location"), OFFSET(chroma_sample_location), AV_OPT_TYPE_INT, {.i64 = AVCHROMA_LOC_UNSPECIFIED }, 0, INT_MAX, V|E|D, "chroma_sample_location_type"},
#if !PAMP_CHANGES
