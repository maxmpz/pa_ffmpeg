...
#if PAMP_CHANGES // Begin PAMP change - avoid forced resample
...
static const AVOption opus_options[] = {
    { "apply_phase_inv", NULL_IF_CONFIG_SMALL("Apply intensity stereo phase inversion"), OFFSET(apply_phase_inv), AV_OPT_TYPE_BOOL, { .i64 = 1 }, 0, 1, AD },
    { NULL },
};
