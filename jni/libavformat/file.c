...
static const AVOption file_options[] = {
    { "truncate", NULL_IF_CONFIG_SMALL("truncate existing files on write"), offsetof(FileContext, trunc), AV_OPT_TYPE_BOOL, { .i64 = 1 }, 0, 1, AV_OPT_FLAG_ENCODING_PARAM }, // PAMP changes
    ...
    { "follow", NULL_IF_CONFIG_SMALL("Follow a file as it is being written"), offsetof(FileContext, follow), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 1, AV_OPT_FLAG_DECODING_PARAM },
    { "seekable", NULL_IF_CONFIG_SMALL("Sets if the file is seekable"), offsetof(FileContext, seekable), AV_OPT_TYPE_INT, { .i64 = -1 }, -1, 0, AV_OPT_FLAG_DECODING_PARAM | AV_OPT_FLAG_ENCODING_PARAM },
    { NULL }
};
