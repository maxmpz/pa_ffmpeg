...
#if !PAMP_CHANGES
    { "live", NULL_IF_CONFIG_SMALL("flag indicating that the input is a live file that only has the headers."), OFFSET(is_live), AV_OPT_TYPE_BOOL, {.i64 = 0}, 0, 1, AV_OPT_FLAG_DECODING_PARAM }, // PAMP change
    { "bandwidth", NULL_IF_CONFIG_SMALL("bandwidth of this stream to be specified in the DASH manifest."), OFFSET(bandwidth), AV_OPT_TYPE_INT, {.i64 = 0}, 0, INT_MAX, AV_OPT_FLAG_DECODING_PARAM },
#endif
    { NULL },
};
