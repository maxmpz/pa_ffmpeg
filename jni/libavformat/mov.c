...
#define av_aes_alloc(...) (0)
#define av_sha_alloc(...) (0)
#define av_sha_init(...) (0)
#define av_sha_update(...) (0)
#define av_sha_final(...) (0)
#define av_aes_init(...) (0)
#define av_aes_crypt(...) (0)
#define av_aes_ctr_free(...) (0)
#define av_aes_ctr_alloc(...) (0)
#define av_aes_ctr_init(...) (0)
#define av_aes_ctr_set_full_iv(...) (0)
#define av_aes_ctr_crypt(...) (0)
...
#if PAMP_CHANGES // Begin PAMP change: extract itunes mp4 aac end_padding, extract replaygain
...
static const AVOption mov_options[] = {
    ...
    {"seek_streams_individually",
        ...
        0, 1, FLAGS},
#if !PAMP_CHANGES
    {"ignore_editlist", NULL_IF_CONFIG_SMALL("Ignore the edit list atom."), OFFSET(ignore_editlist), AV_OPT_TYPE_BOOL, {.i64 = 0},
        0, 1, FLAGS},
#endif
    {"advanced_editlist",
        NULL_IF_CONFIG_SMALL("Modify the AVIndex according to the editlists. Use this option to decode in the order specified by the edits."),
    ...
    { "export_xmp", NULL_IF_CONFIG_SMALL("Export full XMP metadata"), OFFSET(export_xmp),
        AV_OPT_TYPE_BOOL, { .i64 = 0 }, 0, 1, .flags = FLAGS },
    { "activation_bytes", NULL_IF_CONFIG_SMALL("Secret bytes for Audible AAX files"), OFFSET(activation_bytes),
    ...
    { "audible_fixed_key", // extracted from libAAX_SDK.so and AAXSDKWin.dll files!
        NULL_IF_CONFIG_SMALL("Fixed key used for handling Audible AAX files"), OFFSET(audible_fixed_key),
        AV_OPT_TYPE_BINARY, {.str="77214d4b196a87cd520045fd20a51d67"},
        .flags = AV_OPT_FLAG_DECODING_PARAM },
    { "decryption_key", NULL_IF_CONFIG_SMALL("The media decryption key (hex)"), OFFSET(decryption_key), AV_OPT_TYPE_BINARY, .flags = AV_OPT_FLAG_DECODING_PARAM },
    { "enable_drefs", NULL_IF_CONFIG_SMALL("Enable external track support."), OFFSET(enable_drefs), AV_OPT_TYPE_BOOL,
        {.i64 = 0}, 0, 1, FLAGS },
#endif
// End PAMP change
    { NULL },
